...
Claude Code users may link the same directory to `~/.claude/skills/xxd-panel-031`. Restart the agent session after installation.
...
- [Chinese runtime adapter](references/xxd-panel-031-prompt.zh-CN.md)
- [English runtime adapter](references/xxd-panel-031-prompt.en.md)
...
/xxd-panel-031 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-031 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-031 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 031 to a whole directory; shared settings resolve once
/xxd-panel-031 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
