# XXD Panel 025 samples

## Verified original source

- X post: https://x.com/xiaoxiaodong01/status/2090423630320779424
- Author: Xiaoxiaodong (`@xiaoxiaodong01`)
- Project assignment: `VOL.025`
...
- Content source: `group_025`; all four source files are used once in filename order.
- `sample-05.png` ← `group_025/097.jpg`
- `sample-06.png` ← `group_025/098.jpg`
- `sample-07.png` ← `group_025/099.jpg`
- `sample-08.png` ← `group_025/100.png`
- Style identity: XXD Panel 025; reviewed against its original prompt and original X samples.
...
- `sample-09.png` ← `group_025/097.jpg`
- `sample-10.png` ← `group_025/098.jpg`
- `sample-11.png` ← `group_025/099.jpg`
- `sample-12.png` ← `group_025/100.png`
- Style identity: XXD Panel 025; reviewed against its original prompt and original X samples.
