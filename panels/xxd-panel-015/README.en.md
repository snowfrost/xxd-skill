...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 015 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 015 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 015 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 015 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 015 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 015 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 015 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 015 additional top-bottom sample 4"></td>
  </tr>
</table>
...
**Panel 015** is suited to work that must retain the source's essential content while pursuing this visual direction: **Distil the photograph into minimal abstract memory and a complete editorial system**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 015 on this image and recommend the best layout and size first.
...
Claude Code users may link the same directory to `~/.claude/skills/xxd-panel-015`. Restart the agent session after installation.
...
- [Chinese runtime adapter](references/xxd-panel-015-prompt.zh-CN.md)
- [English runtime adapter](references/xxd-panel-015-prompt.en.md)
...
/xxd-panel-015 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-015 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-015 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 015 to a whole directory; shared settings resolve once
/xxd-panel-015 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
