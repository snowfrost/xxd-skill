...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 034 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 034 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 034 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 034 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 034 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 034 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 034 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 034 additional top-bottom sample 4"></td>
  </tr>
</table>
...
**Panel 034** is suited to work that must retain the source's essential content while pursuing this visual direction: **Distil the photograph into one small multicolour rubber stamp and a quiet field note**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 034 on this image and recommend the best layout and size first.
...
|---|---|
| **What you will get** | Distil the photograph into one small multicolour rubber stamp and a quiet field note |
| **Recognizable signature** | SMALL STAMP · 2–4 SPOT INKS · HAND-CARVED LINE · WARM PAPER · FIELD ANNOTATION |
...
/xxd-panel-034 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-034 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-034 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 034 to a whole directory; shared settings resolve once
/xxd-panel-034 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
