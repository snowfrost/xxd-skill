...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 181 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 181 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 181 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 181 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 181 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 181 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 181 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 181 新增上下样张 4"></td>
  </tr>
</table>
...
整体呈现**彩墨写意、小品式构图、墨主色辅、大面积艺术留白与文人画式图文关系**共同形成的高级视觉效果。无论主体是人物、建筑、动物、植物、器物、交通工具或自然景观，都应重在“取其神而舍其繁”，
...
安装后重新启动 Agent 会话，然后调用 `$xxd-panel-181`。也可以按需追加 `--global --agent codex --yes` 做用户级安装。

常用调用示例：

```text
/xxd-panel-181 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale zh-CN
...
完整运行契约见 [SKILL.md](SKILL.md)；运行适配器见 [英文](references/xxd-panel-181-prompt.en.md) 与 [中文](references/xxd-panel-181-prompt.zh-CN.md)。
...
- `design-only`：整张画布只呈现 Panel 181 的设计转译，照片只作为不可见参考。
