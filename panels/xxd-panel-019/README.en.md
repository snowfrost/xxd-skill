...
**Panel 019** is suited to work that must retain the source's essential content while pursuing this visual direction: **Reconstruct a specific photographed subject and relationship as a modernist illustration that remains recognisable**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 019 on this image and recommend the best layout and size first.
...
- [Chinese runtime adapter](references/xxd-panel-019-prompt.zh-CN.md)
- [English runtime adapter](references/xxd-panel-019-prompt.en.md)
- [Original 019 style brief](references/original-prompt/zh-CN.md)
...
/xxd-panel-019 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-019 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-019 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 019 to a whole directory; shared settings resolve once
/xxd-panel-019 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
