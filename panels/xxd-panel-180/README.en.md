...
# XXD Panel 180｜Vintage Circular Travel Stamp
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 180 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 180 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 180 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 180 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 180 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 180 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 180 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 180 additional top-bottom sample 4"></td>
  </tr>
</table>
...
A small circular souvenir stamp combines the main subject with 1–2 environmental clues. Hand-cut rubber/woodcut and etched lines, worn ivory paper, uneven ink, missing impressions and slight registration shifts; 2–3 source-derived faded ink colours, tiny optional gold accents, ample whitespace, an English headline and smaller keywords below.
...
```bash
git clone https://github.com/nevertoday/xxd-panel-180.git
npx skills add https://github.com/nevertoday/xxd-panel-180 --skill xxd-panel-180
```

Restart the agent session after installation, then invoke `$xxd-panel-180`. Add `--global --agent codex --yes` when a user-level Codex installation is wanted.

Common examples:

```text
/xxd-panel-180 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale en-US
/xxd-panel-180 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-180 photo.jpg --mode design-only --size 9:16 --text none
/xxd-panel-180 ./photos --mode design-only --size auto,3:4 --text prompt --locale ja-JP
```

See [SKILL.md](SKILL.md) for the full runtime contract and the [English](references/xxd-panel-180-prompt.en.md) or [Chinese](references/xxd-panel-180-prompt.zh-CN.md) runtime adapter.
...
- `design-only`: the full canvas contains only Panel 180's designed translation; the photograph remains a non-visible reference.
