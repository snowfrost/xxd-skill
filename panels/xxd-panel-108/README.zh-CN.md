...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 108 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 108 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 108 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 108 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 108 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 108 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 108 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 108 新增上下样张 4"></td>
  </tr>
</table>

## 样张展示 / Sample works

本页样张均由 Panel 108 直接依据不同原始参考图独立生成，并已去除 AI 元数据。
...
有些照片已经有很强的身份和情绪，却还需要一种更有设计感的重新组织方式。**Panel 108** 保留照片的现实部分，再把另一半转译成自己的视觉语言，适合艺术海报、独立出版、展览图像、社交内容和纯设计图。
...
当照片主体很有辨识度，却被复杂背景、过度装饰或普通滤镜削弱时，108 用新民艺剪纸重新组织信息：上方保留真实照片，下方只留下主体、轮廓、姿态和叙事关系，转成扁平剪纸、章印感主视觉与版画肌理。

### 适合这些情况

- 想保留照片身份，又需要文化感和手工感的艺术海报、出版封面或展览图像。
- 不想要写实插画、光滑矢量或 3D，而偏好剪影、色块、刻线、正负形与纸张颗粒。
- 需要同一套风格稳定输出上下、左右、纯设计、壁纸、多比例和目录批处理。

### 它替你解决什么

- 删除无关背景和重复物件，避免主体被装饰吞没。
- 从照片提炼 2–4 种辨识度最高的颜色，形成鲜明但克制的民艺色块。
- 统一每张成品的双区逻辑：严格 50:50，不增加标题栏、底栏或第三带。

### 快速判断：Panel 108 适合你吗？

| 你关心的问题 | 这套风格给你的回答 |
|---|---|
| 结果是什么 | 上方真实照片＋下方新民艺剪纸设计的一张完整海报 |
| 一眼特点 | 小尺度章印感主体、平面剪纸色块、版画颗粒、大面积暖白留白 |
| 如何尊重原图 | 保留身份、结构、姿态、光色；下方只做删减与符号化重构 |
...
- 每张图从当前原图一次直达生成，禁止把中间结果、样张或其他 Panel 作品送入第二轮。
- 所有交付都是完整 PNG 位图；不以 SVG、HTML、Canvas 或程序绘图替代成品。

<!-- xxd-panel-catalog:start -->
## XXD Panel 全系列项目

XXD Panel 当前系列已更新至 001–112；每个 Panel 仍保留独立的原始提示词与审美逻辑。下表是本项目发布时的历史目录，连续列出 001–108；当前项目以粗体标出。
