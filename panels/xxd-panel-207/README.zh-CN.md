...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 207 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 207 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 207 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 207 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 207 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 207 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 207 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 207 新增上下样张 4"></td>
  </tr>
</table>
...
整体呈现**小画幅主体、大面积艺术留白、浅蓝白主调、照片与线稿结合、纸感拼贴、轻盈松弛的编辑插页感**，参考 minimal mixed-media collage / whitespace scrapbook layout / centered editorial collage / airy zine-inspired layout。
...
```bash
npx skills add https://github.com/nevertoday/xxd-panel-207 --skill xxd-panel-207
```

安装后重新启动 Agent 会话，然后调用 `$xxd-panel-207`。也可以按需追加 `--global --agent codex --yes` 做用户级安装。

常用调用示例：

```text
/xxd-panel-207 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale zh-CN
/xxd-panel-207 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-207 photo.jpg --mode design-only --size 9:16 --text none --prefs off
/xxd-panel-207 ./photos --mode design-only --size auto,3:4 --text prompt --locale ja-JP
```

完整运行契约见 [SKILL.md](SKILL.md)；运行适配器见 [英文](references/xxd-panel-207-prompt.en.md) 与 [中文](references/xxd-panel-207-prompt.zh-CN.md)。
...
- `design-only`：整张画布只呈现 Panel 207 的设计转译，照片只作为不可见参考。
