...
# XXD Panel 111｜Textile Collage Chronicle

Sew the photograph’s most memorable relationship into a warm visual seal.
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 111 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 111 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 111 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 111 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 111 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 111 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 111 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 111 additional top-bottom sample 4"></td>
  </tr>
</table>
...
Some photographs matter because of a relationship, the feel of clothing, or a quiet pause rather than sheer information. **Panel 111** keeps the photograph's reality and sews the other half into a small visual seal of frayed cloth, fibre, and visible stitches. It suits personal memories, relationships, pets, nature, independent publishing, and exhibition imagery.
...
```bash
git clone https://github.com/nevertoday/xxd-panel-111.git
mkdir -p ~/.codex/skills
ln -s "$(pwd)/xxd-panel-111" ~/.codex/skills/xxd-panel-111
```

You can also install it directly with `npx skills`:

```bash
npx skills add https://github.com/nevertoday/xxd-panel-111 --skill xxd-panel-111
```
...
After installation, restart the agent session and invoke `$xxd-panel-111`.
...
**Signature:** selective memory · hand-sewn textile appliqué · visible stitches · 2–4 vivid source-derived fabric colours · small seal-like subject · generous editorial whitespace

## Quick fit check

| What you need | What Panel 111 gives you |
|---|---|
...
Resolve the visible-text locale explicitly. `prompt` follows the source brief, `exact` passes user copy verbatim, and `none` forbids letters, numbers, logos, and pseudo-text. The Skill never invents a title or guesses language from a person, place, or filename.

## Four output modes

- `top-bottom`: reality above and Panel 111 design below, exactly 50% each.
...
The current XXD Panel series runs from 001 through 112, and every Panel retains its own independent original prompt and aesthetic logic. The table below is the historical catalog as of this project’s release, listing 001 through 111; the current project is bold.
