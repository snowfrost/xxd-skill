...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 111 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 111 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 111 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 111 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 111 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 111 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 111 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 111 新增上下样张 4"></td>
  </tr>
</table>
...
有些照片最动人的地方，不是信息量，而是人物与环境的关系、衣物的触感或一个安静停顿。**Panel 111** 保留照片的现实部分，再把另一半缝成一枚带毛边、布纹和针迹的小尺度视觉章印，适合纪念海报、生活照片、人物关系、宠物与自然场景、独立出版和展览图像。

它解决普通照片滤镜缺少触觉、拼贴素材堆得太满、手作风容易显廉价，以及主体关系在装饰中被淹没的问题。
...
安装后重新启动 Agent 会话，然后调用 `$xxd-panel-111`。
...
**关键词：** 选择性记忆 · 手工纺织拼贴 · 显性针迹 · 2–4 种鲜活布色 · 小尺度章印 · 大面积艺术留白

## 快速判断：Panel 111 适合你吗？

| 你关心的问题 | 这套风格的回答 |
|---|---|
| 想保留照片的温度，又不想做成普通滤镜？ | 上半保留真实照片，下半用布片、毛边和针迹重构同一记忆。 |
| 担心拼贴太满、太像素材堆？ | 只留核心关系，做小尺度章印，周围留出大面积呼吸空间。 |
| 想要手作感但不要廉价手工艺？ | 以 2–4 种源图颜色、真实纤维和克制针迹完成编辑感画面。 |
...
需要文字时必须明确指定语言或地区；`prompt` 按原始提示词生成，`exact` 逐字使用用户文案，`none` 禁止字母、数字、Logo 与伪文字。Skill 不预写标题，也不从人物、地点或文件名猜测语言。

## 四种输出模式

- `top-bottom`：现实照片在上，Panel 111 设计在下，严格各占 50%。
...
XXD Panel 当前系列已更新至 001–112；每个 Panel 仍保留独立的原始提示词与审美逻辑。下表是本项目发布时的历史目录，连续列出 001–111；当前项目以粗体标出。
