...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 026 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 026 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 026 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 026 Sample 8"></td>
  </tr>
</table>
...
**Panel 026** is suited to work that must retain the source's essential content while pursuing this visual direction: **Translate photographic facts into quiet, gentle geometry that remains unmistakably recognisable**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 026 on this image and recommend the best layout and size first.
...
/xxd-panel-026 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-026 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-026 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 026 to a whole directory; shared settings resolve once
/xxd-panel-026 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
