...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 094 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 094 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 094 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 094 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 094 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 094 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 094 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 094 additional top-bottom sample 4"></td>
  </tr>
</table>
...
The eight works above comprise four 16:9 landscape left–right samples and four 3:4 portrait top–bottom samples. Every work was generated independently by Panel 094 from its own original brief; no artwork from another numbered Panel is reused. The samples use intelligent English copy.

<!-- xxd-human-intro:start -->
## What it solves

A tracing filter copies edges; Panel 094 instead keeps only the identity and emotion needed for a poetic book illustration.

**Panel 094** shapes the subject with fine restrained ink, local solid black, and sparse hatching. One colour extracted from the photograph enters only at key points; extreme negative space, optional hand-drawn borders, and classical publishing type turn the result into an early twentieth-century book plate.

### Best for

- preserving identity while deleting background information that is not needed for the scene's meaning;
- fine pen-and-ink book illustration with restrained two-colour printing;
...
> Use XXD Panel 094 on this image and recommend the most suitable composition and size first.
...
|---|---|
| **What you get** | A clean, breathing two-colour illustration resembling an old children's book or poetry frontispiece |
| **Recognisable signature** | fine ink, local solid black, one extracted spot colour, extreme negative space, decorative border, and book typography |
...
Claude Code users may link the same folder under `~/.claude/skills/xxd-panel-094`. Restart the agent session after installation.
...
Full specifications: [Skill workflow](SKILL.md) · [source archive](references/original-prompt/zh-CN.md) · [English runtime adapter](references/xxd-panel-094-prompt.en.md) · [Chinese runtime adapter](references/xxd-panel-094-prompt.zh-CN.md)
...
**Signature:** pen-and-ink book illustration · one extracted spot colour · extreme negative space · decorative border · classical publishing type
...
/xxd-panel-094 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-094 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-094 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 094 to a whole directory; shared settings resolve once
/xxd-panel-094 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
...
The current XXD Panel series runs from 001 through 112, and every Panel retains its own independent original prompt and aesthetic logic. The table below is the historical catalog as of this project’s release, listing 001 through 094; the current project is bold.
