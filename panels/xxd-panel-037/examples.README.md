# XXD Panel 037 samples

## Verified original source

- X post: https://x.com/xiaoxiaodong01/status/2090799598336168140
- Author: Xiaoxiaodong (`@xiaoxiaodong01`)
- Project assignment: `VOL.037`
...
- Content source: `group_012`; all four source files are used once in filename order.
- `sample-05.png` ← `group_012/045.jpg`
- `sample-06.png` ← `group_012/046.jpg`
- `sample-07.png` ← `group_012/047.jpg`
- `sample-08.png` ← `group_012/048.jpg`
- Style identity: XXD Panel 037; reviewed against its original prompt and original X samples.
