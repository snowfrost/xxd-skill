...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 056 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 056 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 056 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 056 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 056 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 056 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 056 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 056 additional top-bottom sample 4"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 056 sample 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 056 sample 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 056 sample 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 056 sample 4"></a></td>
  </tr>
</table>
...
Four further independent sources, different from the 16:9 set, regenerated as complete 3:4 top–bottom canvases. The reality photograph stays above; the lower design follows Panel 056's original brief. English copy is generated only from each photograph's content, mood, or implication, and every result was individually reviewed.
...
**Panel 056** is suited to work that must retain the source's essential content while pursuing this visual direction: **Keep one core image, then repaint it with vast whitespace, paused marks, and warm–cool colour shifts**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 056 on this image and recommend the best layout and size first.
...
```bash
npx skills add https://github.com/nevertoday/xxd-panel-056 --skill xxd-panel-056
```
...
Claude Code users may link the same folder under `~/.claude/skills/xxd-panel-056`. Restart the agent session after installation.
...
Full specifications: [Skill workflow](SKILL.md) · [source archive](references/original-prompt/zh-CN.md) · [English runtime adapter](references/xxd-panel-056-prompt.en.md) · [Chinese runtime adapter](references/xxd-panel-056-prompt.zh-CN.md)
...
```text
/xxd-panel-056 photo.jpg --prefs last
/xxd-panel-056 photo.jpg --prefs edit
/xxd-panel-056 photo.jpg --prefs new
```
