...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 056 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 056 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 056 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 056 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 056 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 056 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 056 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 056 新增上下样张 4"></td>
  </tr>
</table>
## 适用场景与解决的问题
...
**Panel 056** 适合这类任务：需要保留原图核心内容，同时希望最终视觉达到以下方向：**只留一个核心意象，用巨大留白、停顿笔触和暖冷跳色重画照片**。它先从用途与期望结果出发，再决定构图、尺寸、文字和具体输出形式。
...
> 用 XXD Panel 056 帮我处理这张图，先推荐最合适的构图和尺寸。
...
| 你关心的问题 | 这套风格给你的回答 |
|---|---|
| **你会得到什么** | 只留一个核心意象，用巨大留白、停顿笔触和暖冷跳色重画照片 |
...
完整规格: [Skill 工作流](SKILL.md) · [原始风格档案](references/original-prompt/zh-CN.md) · [英文运行适配器](references/xxd-panel-056-prompt.en.md) · [中文运行适配器](references/xxd-panel-056-prompt.zh-CN.md)
